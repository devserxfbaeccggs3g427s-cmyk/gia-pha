package com.familya.gateway.archunit;
...
@AnalyzeClasses(packages = "com.familya.gateway", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.gateway..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.gateway.(*)..").should().beFreeOfCycles();
}
