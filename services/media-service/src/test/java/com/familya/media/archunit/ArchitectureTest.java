package com.familya.media.archunit;
...
@AnalyzeClasses(packages = "com.familya.media", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.media..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.media.(*)..").should().beFreeOfCycles();
}
