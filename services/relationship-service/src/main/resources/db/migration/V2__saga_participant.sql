...
-- Each participant service stores the compensation snapshot used to undo a
-- Saga step before the irreversible boundary. The snapshot is JSON so the
-- schema can evolve without migrations for each new field.
