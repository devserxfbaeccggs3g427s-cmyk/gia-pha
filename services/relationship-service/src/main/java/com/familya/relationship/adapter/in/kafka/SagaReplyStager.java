...
/**
 * Stages a Saga participant reply on the local outbox. The reply is published
 * by the platform outbox worker on the participant reply topic
 * ({@code relationship.replies.v1}) partitioned by {@code treeId}.
 */
@Component
