package com.familya.relationship.archunit;
...
@AnalyzeClasses(packages = "com.familya.relationship", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.relationship..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.relationship.(*)..").should().beFreeOfCycles();
}
