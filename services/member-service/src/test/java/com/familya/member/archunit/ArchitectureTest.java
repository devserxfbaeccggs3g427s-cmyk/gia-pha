package com.familya.member.archunit;
...
@AnalyzeClasses(packages = "com.familya.member", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.member..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.member.(*)..").should().beFreeOfCycles();
}
