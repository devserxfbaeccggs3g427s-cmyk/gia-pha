...
/**
 * Writer cho bảng {@code operation_audit} của Member service.
 *
 ...
 * {@link com.familya.platform.api.AsyncOperation} cho client. Optimistic
 * concurrency thông qua cột {@code version} được dùng cho mọi update
 * (transition operation state).</p>
 */
@Component
