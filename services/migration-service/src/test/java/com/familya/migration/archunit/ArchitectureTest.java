...
@AnalyzeClasses(packages = "com.familya.migration", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.migration..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.migration.(*)..").should().beFreeOfCycles();
}
