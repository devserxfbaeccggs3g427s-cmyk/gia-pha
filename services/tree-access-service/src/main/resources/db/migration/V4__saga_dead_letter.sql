...
CREATE TABLE tree_saga_dead_letter (
    id                   CHAR(36)     NOT NULL,
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uq_tree_saga_dl_source (consumer, source_kind, source_key),
    KEY ix_tree_saga_dl_operation (operation_id, occurred_at),
    KEY ix_tree_saga_dl_occurred_at (occurred_at)
