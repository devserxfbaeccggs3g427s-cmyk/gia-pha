package com.familya.treeaccess.archunit;
...
@AnalyzeClasses(packages = "com.familya.treeaccess", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    @ArchTest static final ArchRule no_cross_service_imports =
            noClasses().that().resideInAPackage("com.familya.treeaccess..")
    ...
    @ArchTest static final ArchRule no_cycles = slices().matching("com.familya.treeaccess.(*)..").should().beFreeOfCycles();
}
